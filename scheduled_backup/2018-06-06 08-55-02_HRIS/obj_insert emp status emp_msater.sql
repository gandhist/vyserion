...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `insert emp status emp_msater` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `insert emp status emp_msater` AFTER INSERT ON `hr_hist_status` FOR EACH ROW BEGIN
