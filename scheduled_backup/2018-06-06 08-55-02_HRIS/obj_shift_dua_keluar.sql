...
/* Function  structure for function  `shift_dua_keluar` */

/*!50003 DROP FUNCTION IF EXISTS `shift_dua_keluar` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`gandhi`@`localhost` FUNCTION `shift_dua_keluar`(p_pin INT(20), p_datetime VARCHAR(50)) RETURNS varchar(50) CHARSET latin1
BEGIN
