         ...
         <div class="box">
            ...
            <div class="panel-body">
                <form id="form-filter" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="filter_start" class="col-sm-2 control-label">Start Date</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label for="filter_end" class="col-sm-2 control-label">End Date</label>
                        <div class="col-sm-4">
