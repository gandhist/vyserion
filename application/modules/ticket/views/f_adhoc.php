<div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
            ...
            <div class="box-body">
              <form action="#" id="form-import" enctype="multipart" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <button type="button" id="btn_import" class="btn btn-primary">Import Data</button>
                           <!--  <button type="button" id="btnSave" onclick="add()" class="btn btn-primary">Save</button> -->
                           <!--  <button type="button" id="btn-reset" onclick="reset_form()" class="btn btn-default">Reset</button> -->
                        </div>
                    </div>
                    <!-- button waiting while uploading -->
        ...
        <div class="col-xs-12">
         <div class="box">
            ...
            <div class="panel-heading">
                <h3 class="panel-title" >Input Allowance & Deduction : </h3>
            </div>
        ...
        <input type="text" style="display:none;" name="f_id_adhoc" id="f_id_adhoc" value="">
                    ...
                    <div class="form-group">
                        <label for="f_adhoc_date" class="col-sm-2 control-label">Date</label>
                        <div class="col-sm-4">
                            <input type="text" name="f_adhoc_date" id="f_adhoc_date" class="form-control" placeholder="dd-mm-yyyy" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask > <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="f_adhoc_code" class="col-sm-2 control-label">Allow-Ded Code</label>
                        <div class="col-sm-4">
                                  <?php
                                  $attribute_attd = 'class="form-control select2" id="f_adhoc_code" style="width: 100%; display:none;"';
                                  echo form_dropdown('f_adhoc_code', $dd_adhoc, $dd_adhoc_selected, $attribute_attd);?>
                                  <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="f_amount" class="col-sm-2 control-label">Amount</label>
                        <div class="col-sm-4">
                            <input type="text" name="f_amount" id="f_amount" class="form-control" placeholder="Amount"> <span class="help-block"></span>
                        </div>
                    </div>                    
                    <div class="form-group">
