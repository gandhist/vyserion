...
class Payroll_model extends CI_Model {
	...
	var $table = 'help_desk';
	var $column_order = array('id', 'request_by', 'request_date', 'solve_date', 'status',null); //set column field database for datatable orderable
	var $column_search = array('id', 'request_by', 'request_date', 'solve_date', 'status'); //set column field database for datatable searchable just firstname , lastname , address are searchable
	...
	private function _get_datatables_query()
	{
       ...
       /* if($this->input->post('f_empcode'))
            {
                $this->db->where('gang_activity.empcode', $this->input->post('f_empcode'));
            }
        ...
        $this->db->select('id, request_by, request_date, problem, solved_by, remarks, solve_date, status');
