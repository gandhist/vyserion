...
class Adhoc_model extends CI_Model {
	...
	var $table = 'empallded';
	var $column_order = array('a.empcode', 'b.empname', 'a.adhoc_date', 'a.allowded_code', 'c.description', 'a.amount',null); //set column field database for datatable orderable
	var $column_search = array('a.empcode', 'b.empname', 'a.adhoc_date', 'a.allowded_code', 'c.description', 'a.amount'); //set column field database for datatable searchable just firstname , lastname , address are searchable
	...
	private function _get_datatables_query()
	{
        ...
        $this->db->select('a.id_adhoc, a.empcode, b.empname, a.adhoc_date, c.description, a.allowded_code, a.amount, a.remarks');
        $this->db->from('empallded a, emp_master b, master_adhoc c');
