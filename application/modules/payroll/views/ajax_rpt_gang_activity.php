...
/*  start_date = $('#filter_start_date').val();
   ...
   table = $('#table').DataTable({ 
    ...
    $('#btn-xls').click(function(){
        ...
        var xlsData = {
            'period' : $('#period_xls').val(), 
            'year' : $('#year_xls').val() 
        };
        var url = "<?php echo base_url('payroll/rpt_inputan'); ?>/"+xlsData.period+'/'+xlsData.year;
        $.ajax({
            url : "<?php echo base_url('payroll/rpt_inputan'); ?>/"+xlsData.period+'/'+xlsData.year,
            type : "POST",
            data : xlsData,
            /*data : function(data)
            {
            ...
            {
                //alert();
                var period = $('#period_xls').val()
                var year = $('#year_xls').val()
                //console.log(data);
