...
$(document).ajaxStart(function () {
    Pace.restart()
            ...
            $(document).ready(function () {
                ...
                $("#report_sallary").addClass("active");
...
$(document).ready(function() {
    ...
    $('#f_type').on('select2:select', function(){
        ...
        switch (type) {
            case "pdf":
            $('#form-filter').attr('action','<?php echo base_url(); ?>payroll/rekap_sallary');                
                break;
        
            default:
            $('#form-filter').attr('action','<?php echo base_url(); ?>payroll/rekap_sallary_xls');
                break;
        }
    });
