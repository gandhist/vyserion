        ...
        <div class="col-xs-12">
         <div class="box">
            ...
            <div class="panel-body">
                <form action="<?php echo base_url(); ?>payroll/download_slip_gaji" id="form-filter"  target="_blank" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <button type="submit" id="btn-filter" class="btn btn-primary">Download</button>
