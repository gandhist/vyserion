...
class Ump_model extends CI_Model {
	...
	var $table = 'master_ump';
	var $column_order = array('id', 'rate', 'effective_date', 'remarks',null); //set column field database for datatable orderable
	var $column_search = array('id', 'rate', 'effective_date', 'remarks'); //set column field database for datatable searchable just firstname , lastname , address are searchable
	...
	private function _get_datatables_query()
	{
        ...
        $this->db->select('id, MAX(effective_date) AS effective_date, rate, remarks');
