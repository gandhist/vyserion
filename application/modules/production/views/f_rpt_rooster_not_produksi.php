        ...
        <div class="col-xs-12">
         <div class="box">
            ...
            <div class="panel-body">
                <form action="<?php echo base_url(); ?>production/export_rooster_ex_pro_rev1" id="form-filter"  target="_blank" method="POST" class="form-horizontal">
export_rooster_ex_pro_rev1
