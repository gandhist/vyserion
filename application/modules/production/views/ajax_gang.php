...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('production/gang_list')?>",
            "type": "POST",
            "data": function (data) {
...
function edit_data(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('production/gang_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            //===== left side is input name and then right side is field name
            $('[name="f_id_gang"]').val(data.id_gang);
            $('[name="f_gang_name"]').val(data.gang_name);
...
function sav()
{
    ...
    if (save_method == 'add') {
        ...
        url = "<?php echo site_url('production/gang_add') ?>";
        $.ajax({
            url: url,
            type: 'POST',
            data: formData,
    ...
    else 
    {
        ...
        url = "<?php echo site_url('production/gang_update')?>";
        var formData = new FormData($('#form')[0]);
    $.ajax({
        url : url,
        type: "POST",
...
function inactive(id)
{
    ...
    if(confirm('Are you sure to inactive this vehicle?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('production/inactive_gang')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
