...
<div class="col-md-6">
          <div class="box box-default collapsed-box">
            ...
            <div class="box-body">
              <form action="#" id="form_filters" class="form-horizontal">
                   ...
                   <!--  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="f_period" class="col-sm-3 control-label">Period</label>
                         <div class="col-sm-4">
                          <select class="form-control select2" style="width: 100%;" name="f_period_f" id="f_period_f">
            ...
            <option value="12">12</option>
                    ...
                    <div class="form-group">
                        <label for="f_year" class="col-sm-3 control-label">Year</label>
                         <div class="col-sm-4">
                          <select class="form-control select2" style="width: 100%;" id="f_year_f" name="f_year_f">
 ...
 -->                </form>
        ...
        <div class="col-xs-12">
         <div class="box">
            ...
            <div class="panel-heading">
                <h3 class="panel-title" >Input Rooster Karyawan: </h3>
            </div>
            ...
            <div class="panel-body">
                <!-- <form id="form-filter" class="form-horizontal"> -->
                  <form action="#" method="POST" id="form" class="form-horizontal">
                    ...
                    <input type="text" style="display:none;"  name="f_id_rooster" id="f_id_rooster" value="<?php echo $last_id+1; ?>">
        ...
        <div class="col-xs-6">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="f_period" class="col-sm-4 control-label">Period</label>
                         <div class="col-sm-8">
                          <select class="form-control select2" style="width: 100%;" name="f_period" id="f_period">
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
            <option value="4">4</option>
            ...
            <option value="12">12</option>
                    ...
                    <div class="form-group">
                        <label for="f_year" class="col-sm-4 control-label">Year</label>
                         <div class="col-sm-8">
                          <select class="form-control select2" style="width: 100%;" id="f_year" name="f_year">
              <option value="2018">2018</option>
            <option value="2019">2019</option>
            <option value="2020">2020</option>
          </select><span class="help-block"></span>
                    ...
                    <div class="form-group">
                        <label for="f_begin_work" class="col-sm-4 control-label">Begin Work From</label>
                         <div class="col-sm-8">
            ...
            <option value="602">6#OM</option>
                    ...
                    <div class="form-group" id="f_div_day">
                        <label for="f_day" class="col-sm-4 control-label">Day Start</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" id="f_remarks" name="f_remarks"></textarea></select><span class="help-block"></span>
                        </div>
                    </div>
                ...
                <!--     <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div id="input_indicator" class="overlay">
              <i class="fa fa-refresh fa-spin"></i>
            </div>
                        </div>
                    </div>
