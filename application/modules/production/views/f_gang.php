...
<!-- begin form upload -->
        ...
        <div class="col-xs-12">
         <div class="box">
            ...
            <div class="panel-heading">
                <h3 class="panel-title" >Input Gang : </h3>
            </div>
        ...
        <input type="text" style="display:none;" name="f_id_gang" id="f_id_gang" value="">

        <div class="col-xs-6">
                    
                    <div class="form-group">
                        <label for="f_gang_name" class="col-sm-2 control-label">Gang Name</label>
                        <div class="col-sm-10">
                            ...
                            <input type="text" name="f_gang_name" id="f_gang_name" class="form-control" placeholder="Gang Name"> <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="f_gang_desc" class="col-sm-2 control-label">Gang Description</label>
                         <div class="col-sm-10">
                            <input type="text" name="f_gang_desc" id="f_gang_desc" class="form-control" placeholder="Description" > <span class="help-block"></span>
                        </div>
                    </div>
