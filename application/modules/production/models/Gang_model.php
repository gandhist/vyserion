...
class Gang_model extends CI_Model {
	...
	var $table = 'gang';
	var $column_order = array('gang_name', 'start_date', 'gang_desc', 'remarks', 'active',null); //set column field database for datatable orderable
	var $column_search = array('gang_name', 'start_date', 'gang_desc', 'remarks', 'active'); //set column field database for datatable searchable just firstname , lastname , address are searchable
	var $order = array('id_gang' => 'desc'); // default order 
	...
	private function _get_datatables_query()
	{
        ...
        $this->db->select('id_gang, gang_name, start_date, gang_desc, remarks, active');
