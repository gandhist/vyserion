...
<div class="col-md-4">
          <div class="box box-default collapsed-box">
            <div class="box-header with-border">
              <h3 class="box-title" data-widget="collapse"><i class="fa fa-filter"></i> Rpt Progress Unit</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php echo site_url('ts/rpt_pauama_daily'); ?>" method="POST" id="form_rpt_progress_unit" class="form-horizontal" target="_blank">
                    <div class="form-group">
                        <label for="filter_month" class="col-sm-3 control-label">Start Date</label>
                        <div class="col-sm-4">
                            <!-- <input type="text" class="form-control" id="filter_start_date"> -->
                    ...
                    <div id="loading_rpt_prog" class="overlay">
...
<!-- begin form upload -->
        ...
        <div class="col-xs-3">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="f_condition" class="col-sm-4 control-label">Report Type</label>
                        <div class="col-sm-8">
                            <input type="radio" name="rpt_type" id="rpt_type" checked value="daily">Daily
                            <input type="radio" name="rpt_type" id="rpt_type_b" value="historical">Histoical <span class="help-block"></span>
                        </div>
                    </div>

                    <div id="warning" class="callout callout-warning">
                        <h4>Please Update Date Finish Estimate</h4>

                        <p>Please update date estimate expired on <a href="<?php echo site_url('ts/breakdown'); ?>">Breakdown Units</a>.</p>
                    </div>
                    <div id="warning_pr" class="callout callout-info">
                        <h4>Please Update No PR or SR</h4>

                        <p>Please update No PR or SR that still empty on <a href="<?php echo site_url('ts/breakdown'); ?>">Breakdown Units</a>.</p>
                    </div>
...
<!-- ini untuk submit form pdf -->
                ...
                <form action="<?php echo base_url('ts/rpt_downtime_pdf_v2'); ?>" method = "POST" class="form-horizontal" name="downtime_pdf" id="downtime_pdf" target="_blank">
                    <!-- end of form submit -->
                    ...
                    <input type="text" style="display:none;" name="tmp_rpt_type" id="tmp_rpt_type">
                            ...
                            <button type="button" id="btn-reset" onclick="reset_form()" class="btn btn-default"><i class="icon fa fa-history"></i> Reset</button>
                            <a href="mailto:anang.sasongko@prime-pim.com?subject=Report Downtime Unit&body=TThe message&attachment=D:\log_in.jpg">
    Send Email to HO
</a>
                    <!-- end of form submit -->
                    </form>
