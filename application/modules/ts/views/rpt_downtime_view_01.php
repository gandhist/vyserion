...
<table id="customers" style="table-layout: 100%">
	<tr style="color: #333; font-weight:bold; font-size: 8px; text-align: center">
		...
		<td bgcolor='#ffaf10' width="3.2%">Status Damage </td>
	...
	<tr>
		...
		<td><?php echo $key->pa; ?></td>
		<td><?php echo $key->ua; ?></td>
...
<div id="footer">
<a href="https://sis.cat.com/sisweb" target="_blank" style="color: #333; font-weight:bold; font-size: 10px; text-align: center">Link to SIS</a>
