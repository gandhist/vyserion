     ...
     $('#f_code_unit').on('select2:select', function(){
        ...
        $.ajax({
            ...
            success : function(data)
            {
                ...
                if (data.status_bd === "no_data_stored") {
                    //alert("tidak ada record breakdown.");
                    $('#btnSave').attr('disabled',false);
                    $('#status_operasi').addClass('callout callout-success');
                $('#sts_opr_bd').text("No Stored Data!!");

                }
                if (data[0].status_bd === "OPERATION") {
                    //alert("tidak ada record breakdown.");
                    $('#btnSave').attr('disabled',false);
                    $('#status_operasi').addClass('callout callout-success');
                ...
                if (data[0].status_bd === "BREAKDOWN") {
                    ...
                    $('#status_operasi').removeClass();
                    $('#status_operasi').addClass('callout callout-danger');
                }
               /* if (data[0].status_bd === "BREAKDOWN") {
                    $('#btnSave').attr('disabled',true);
                }*/
...
/*jika status bd di klik maka akan mengubah isi field status_bd_temp*/
     ...
     */
     $('#f_date_bd').change(function()
     {
        ...
        //console.log(date_bd);
        //console.log(now);
        var ms = moment(now,"DD/MM/YYYY HH:mm").diff(moment(date_bd,"DD/MM/YYYY HH:mm"));
        var d = moment.duration(ms);
        var beda = d.asHours();
        //console.log(beda);
        if (beda < 0) {
            $('#btnSave').attr('disabled',true);
            $('#f_date_bd').parent().parent().addClass('has-error'); //select parent twice to select div form-group class and add has-error class
            $('#f_date_bd').next().text("Invalid Date Time Breakdown!!");
        }
        else 
        {
            $('#btnSave').attr('disabled',false);
            $('#f_date_bd').parent().parent().removeClass('has-error'); //select parent twice to select div form-group class and add has-error class
            $('#f_date_bd').next().text("");
     ...
     $('#f_date_finish').change(function(){
         ...
         // validasi
         var date_start  = $('#f_date_bd').val();
         var date_finish = $('#f_date_finish').val();
        var now = moment().format("DD-MM-YYYY HH:mm");
        //console.log(date_bd);
        //console.log(now);
        var ms = moment(now,"DD/MM/YYYY HH:mm").diff(moment(date_finish,"DD/MM/YYYY HH:mm"));
        var d = moment.duration(ms);
        var beda = d.asHours();
        //console.log(beda);
        
        var start_vs_end = moment(date_start,"DD/MM/YYYY HH:mm").diff(moment(date_finish,"DD/MM/YYYY HH:mm"));
        var se = moment.duration(start_vs_end);
        var diff = se.asHours();
        //console.log(diff);

        if (beda < 0) {
            $('#btnSave').attr('disabled',true);
            $('#f_date_finish').parent().parent().addClass('has-error'); //select parent twice to select div form-group class and add has-error class
            $('#f_date_finish').next().text("Invalid Date Time Breakdown!!");
        }
        if(diff > 0 )
        {
            $('#btnSave').attr('disabled',true);
            $('#f_date_finish').parent().parent().addClass('has-error'); //select parent twice to select div form-group class and add has-error class
            $('#f_date_finish').next().text("Date finish must bigger than date start!");
        }
        else 
        {
            $('#btnSave').attr('disabled',false);
            $('#f_date_finish').parent().parent().removeClass('has-error'); //select parent twice to select div form-group class and add has-error class
            $('#f_date_finish').next().text("");
...
{   
    ...
    var jam_enam = moment("06:00",'HH:mm').format('HH:mm');
    ...
    var jam_duaempat = moment('00:00','HH:mm').format('HH:mm');
    ...
    var shift_dua_enam = moment(get_tanggal_finish+" "+ jam_enam ,'DD-MM-YYYY HH:mm').format('DD-MM-YYYY HH:mm')
    ...
    var par_min_tigaa = moment(get_tanggal_start+ " "+bd_min_tiga, 'DD-MM-YYYY HH:mm').format('DD-MM-YYYY HH:mm');
    ...
    /*jika breakdown 1 hari atau pindah tanggal, overhaul atau shift 2 malam*/
        ...
        /* jika finish breakdown di jam istirahat jam 17 - 19 */
        if(date_start >= shift_dua_sembilanbelas && date_start <= shift_dua_duaempat && date_finish > shift_dua_duaempat && date_finish <= shift_dua_satu_tgl_plus_satu) 
        {
            //alert("sounds goods");
            var jam_tujuhbelas = moment('00:00','HH:mm').format('HH:mm');
            var get_tanggal_finish = moment(date_finish, 'DD-MM-YYYY HH:mm').format('DD-MM-YYYY');
            var shift_satu_tujuhbelas = moment(get_tanggal_finish+" "+ jam_tujuhbelas ,'DD-MM-YYYY HH:mm').format('DD-MM-YYYY HH:mm');
            console.log('19:00 - 24:00/01:00 breakdown shift pagi, melewati atau diantara jam istirahat, potong proporsional');
            //console.log(date_start);
            //console.log(shift_satu_duabelas);
            hitung_downtime_kurang(shift_satu_tujuhbelas, date_start);
        }
        /* jika finish breakdown di jam istirahat jam 17 - 19 dan 12 */
        else if(date_start >= shift_satu_tujuh && date_start <= shift_satu_duabelas && date_finish > shift_dua_duaempat && date_finish <= shift_dua_satu_tgl_plus_satu) 
        {
            var bd_min_dua = moment(get_hour_start, 'HH:mm').add('+2','hours').format('HH:mm');
            var par_min_dua = moment(get_tanggal_start+ " "+bd_min_dua, 'DD-MM-YYYY HH:mm').format('DD-MM-YYYY HH:mm');
            //alert("sounds goods");
            var jam_tujuhbelas = moment('00:00','HH:mm').format('HH:mm');
            var get_tanggal_finish = moment(date_finish, 'DD-MM-YYYY HH:mm').format('DD-MM-YYYY');
            var shift_satu_tujuhbelas = moment(get_tanggal_finish+" "+ jam_tujuhbelas ,'DD-MM-YYYY HH:mm').format('DD-MM-YYYY HH:mm');
            console.log('07:00 - 24:00/01:00 dan pot 2 jam 17-19 breakdown shift pagi, melewati atau diantara jam istirahat, potong proporsional');
            console.log(par_min_dua);
            //console.log(date_start);
            //console.log(shift_satu_duabelas);
            hitung_downtime_kurang(shift_satu_tujuhbelas, par_min_dua);
        }
        /*19:00 - +1 05:00*/
        ...
        /* jika finish breakdown di jam istirahat jam 17 - 19 dan 12 */
        else if(date_start >= shift_satu_tigabelas && date_start <= shift_dua_duaempat && date_finish > shift_dua_duaempat && date_finish <= shift_dua_satu_tgl_plus_satu) 
        {
            var bd_min_dua = moment(get_hour_start, 'HH:mm').add('+2','hours').format('HH:mm');
            var par_min_dua = moment(get_tanggal_start+ " "+bd_min_dua, 'DD-MM-YYYY HH:mm').format('DD-MM-YYYY HH:mm');
            //alert("sounds goods");
            ...
            var get_tanggal_finish = moment(date_finish, 'DD-MM-YYYY HH:mm').format('DD-MM-YYYY');
            var shift_satu_tujuhbelas = moment(get_tanggal_finish+" "+ jam_tujuhbelas ,'DD-MM-YYYY HH:mm').format('DD-MM-YYYY HH:mm');
            console.log('13:00 - 24:00/01:00 dan 17-19 breakdown shift pagi, melewati atau diantara jam istirahat, potong proporsional');
            console.log(par_min_dua);
            //console.log(date_start);
            //console.log(shift_satu_duabelas);
            hitung_downtime_kurang(shift_satu_tujuhbelas, par_min_dua);
        ...
        else if(date_start >= shift_satu_tigabelas && date_start <= shift_satu_tujuhbelas && date_finish <= shift_dua_lima)
        {
            ...
            console.log(par_min_satu);
            console.log(par_min_tigaa);
            hitung_downtime_kurang(par_min_tigaa, date_start);
        }
        ...
        else if (date_start >= shift_satu_tujuh && date_start <= shift_satu_duabelas && date_finish >= shift_dua_satu && date_finish <= shift_dua_enam) {
            console.log('07:00 - besok jam 05:00 fuck');
            console.log('parmin empat'+par_min_empat_awal);
            console.log(date_start);
        ...
        else if(date_start <= shift_dua_lima) {
            console.log('ini breakdown lebih dari 1 hari, antara jam 01 hari breakdown +1 s/d tanggal besok jam 05:00.');
            hitung_ma();
        }
    ...
    else
    {
        ...
        /* jika finish breakdown di jam istirahat jam 12 */
        if(date_start >= shift_satu_tujuh && date_start <= shift_satu_duabelas && date_finish > shift_satu_duabelas && date_finish <= shift_satu_tigabelas) 
        // else if(date_start >= shift_satu_tujuh_finish && date_start <= shift_satu_duabelas )
        {
            //alert("sounds goods");
            var jam_duabelas = moment('12:00','HH:mm').format('HH:mm');
            var get_tanggal_finish = moment(date_finish, 'DD-MM-YYYY HH:mm').format('DD-MM-YYYY');
            var shift_satu_duabelas = moment(get_tanggal_finish+" "+ jam_duabelas ,'DD-MM-YYYY HH:mm').format('DD-MM-YYYY HH:mm');
            console.log('07:00 - 12:00 breakdown shift pagi, melewati jam istirahat, potong proporsional');
            //alert("holyshit");
            //console.log(date_start);
            //console.log(shift_satu_duabelas);
            hitung_downtime_kurang(shift_satu_duabelas, date_start);
        }
        /*07:00 - 12:00*/
        else if (date_start >= shift_satu_tujuh && date_start <= shift_satu_duabelas && date_finish <= shift_satu_duabelas) {
        ...
        /*13:00 - 17:00*/
         ...
         /* jika finish breakdown di jam istirahat jam 17 - 19 */
         else if(date_start >= shift_satu_tigabelas && date_start <= shift_satu_tujuhbelas && date_finish > shift_satu_tujuhbelas && date_finish <= shift_dua_sembilanbelas) 
        {
            //alert("sounds goods");
            var jam_tujuhbelas = moment('17:00','HH:mm').format('HH:mm');
            var get_tanggal_finish = moment(date_finish, 'DD-MM-YYYY HH:mm').format('DD-MM-YYYY');
            var shift_satu_tujuhbelas = moment(get_tanggal_finish+" "+ jam_tujuhbelas ,'DD-MM-YYYY HH:mm').format('DD-MM-YYYY HH:mm');
            console.log('13:00 - 17:00/19:00 breakdown shift pagi, melewati atau diantara jam istirahat, potong proporsional');
            //console.log(date_start);
            //console.log(shift_satu_duabelas);
            hitung_downtime_kurang(shift_satu_tujuhbelas, date_start);
        }
        ...
        /*13:00 - 24:00*/
         ...
         /* jika finisih di jam istirahat */

          /*07:00 - 24:00 dan melewati range jam istirahat 12:00-13:00, 17:00 - 19:00, 1jam + 2 jam = 3 jam*/
        else if(date_start >= shift_satu_tujuh && date_finish >= shift_dua_sembilanbelas && date_finish <= shift_dua_duaempat ) {
            console.log('07:00 - 24:00 breakdown shift pagi, melewati jam istirahat, potong 3 jam');
            hitung_downtime_kurang(par_min_tiga, date_start);
        }
        /* jika finish breakdown di jam istirahat jam 17 - 19 dan 12 */
        else if(date_start >= shift_satu_tujuh && date_start <= shift_satu_duabelas && date_finish > shift_satu_tujuhbelas && date_finish <= shift_dua_sembilanbelas) 
        {
            var bd_min_dua = moment(get_hour_start, 'HH:mm').add('+1','hours').format('HH:mm');
            var par_min_dua = moment(get_tanggal_start+ " "+bd_min_dua, 'DD-MM-YYYY HH:mm').format('DD-MM-YYYY HH:mm');
            //alert("sounds goods");
            var jam_tujuhbelas = moment('17:00','HH:mm').format('HH:mm');
            var get_tanggal_finish = moment(date_finish, 'DD-MM-YYYY HH:mm').format('DD-MM-YYYY');
            var shift_satu_tujuhbelas = moment(get_tanggal_finish+" "+ jam_tujuhbelas ,'DD-MM-YYYY HH:mm').format('DD-MM-YYYY HH:mm');
            console.log('07:00 - 24:00/01:00 dan 17-19 breakdown shift pagi, melewati atau diantara jam istirahat, potong proporsional');
            console.log(par_min_dua);
            //console.log(date_start);
            //console.log(shift_satu_duabelas);
            hitung_downtime_kurang(shift_satu_tujuhbelas, par_min_dua);
         ...
         /*19:00 - 24:00*/
        else if(date_start >= shift_dua_sembilanbelas && date_start <= shift_dua_duaempat && date_finish <= shift_dua_duaempat)
        {
