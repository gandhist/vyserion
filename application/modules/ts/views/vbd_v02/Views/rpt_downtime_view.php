...
<html>
<head>
	<title>REPORT HISTORY DOWNTIME TANGGAL</title>
...
<img height="55" width="48" class="imgFloatLeft" src="<?php echo $_SERVER["DOCUMENT_ROOT"].'/hris/assets/company.jpg';?>"/>
<center> 
...
<table id="customers" style="table-layout: fixed">
	<tr style="color: #333; font-weight:bold; font-size: 8px; text-align: center">
		...
		<td bgcolor='#ffaf10' width="4.2%">SN Unit </td>
		<td bgcolor='#ffaf10' width="1.7%">NAP </td>
		<td bgcolor='#ffaf10' width="15%">Problem Occured/Remarks </td>
		<td bgcolor='#ffaf10' width="3.2%">Status </td>
		<td bgcolor='#ffaf10' width="2%">HM </td>
		<td bgcolor='#ffaf10' width="4%">Time Breakdown </td>
		<td bgcolor='#ffaf10' width="3.6%">Status Damage </td>
		<td bgcolor='#ffaf10' width="4%">Opr/ Calculate </td>
		<td bgcolor='#ffaf10' width="1.6%">MA % </td>
		<td bgcolor='#ffaf10' width="1.8%">TDr(Hr) </td>
	...
	<tr>
		...
		<td><?php echo $key->tdy; ?></td>
		<!-- <td><?php echo $key->possible_work; ?></td>
...
<div class="page" style="page-break-after: never">
	...
	<table id="customers" style="table-layout: fixed">
		<tr style="color: #333; font-weight:bold; font-size: 8px; text-align: center">
			...
			<td bgcolor='#ffaf10' width="3.4%">SN Unit </td>
		...
		foreach ($data_bd_det as $key) {
			...
			<tr>
				...
				<td><?php echo $key->nama_vendor; ?></td>
				<td><?php echo $key->status_parts_job; ?></td>
				<td style="white-space: pre-line;" ><?php echo $key->no_po; ?></td>
				<td style="white-space: pre-line;" ><?php echo $key->no_pr_sr; ?></td>
				<td style="white-space: pre-line;" > <?php echo $key->reason_bd; ?></td>
			</tr>
...
<div id="footer">
<a href="https://login.cat.com/cgi-bin/login" target="_blank" style="color: #333; font-weight:bold; font-size: 10px; text-align: center">Link to SIS</a>
<a href="https://trakindo.cat.com/DSFUnbundled/login.do" target="_blank" style="color: #333; font-weight:bold; font-size: 10px; text-align: center">Link to PartStore</a>
