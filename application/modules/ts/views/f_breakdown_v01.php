        ...
        <div class="col-xs-12">
         <div class="box">
            ...
            <div class="panel-heading">
                <h3 class="panel-title" >Input Breakdown Unit : </h3>
            </div>
            ...
            <div class="panel-body">
                <!-- <form id="form-filter" class="form-horizontal"> -->
                  <form action="#" id="form" class="form-horizontal">
                    ...
                    <input type="text" style="display:none;" name="status_lvl_temp" id="status_lvl_temp" >
        ...
        <div class="col-xs-3">
                   ...
                   <div id="status_operasi" class="callout callout-success">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="f_kwitansi" class="form-control" id="f_kwitansi"> 
                                  <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="f_condition" class="col-sm-4 control-label">HM BD</label>
                        <div class="col-sm-8">
                   ...
                   <div class="form-group">
                    ...
                    <!-- <div class="form-group">
                        <label for="f_condition" class="col-sm-4 control-label">HM Start</label>
                        <div class="col-sm-8">
                            <input type="text" name="f_hm_start" class="form-control" id="f_hm_start"> 
                                  <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="f_condition" class="col-sm-4 control-label">HM Finish</label>
                        <div class="col-sm-8">
                            <input type="text" name="f_hm_finish" class="form-control" id="f_hm_finish"> 
                                  <span class="help-block"></span>
                        </div>
                    </div>
 -->
        ...
        <div class="col-xs-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="form-control" id="f_pr" name="f_pr"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="form-control" id="f_po" name="f_po"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="f_pw" class="form-control" id="f_pw" value="19"> 
                                  <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="f_tdr" id="f_tdr" class="form-control" >
                                  <span class="help-block"></span>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="f_condition" class="col-sm-4 control-label">Total BD Day</label>
                        <div class="col-sm-8">
                            <input type="text" name="f_tdy" id="f_tdy" class="form-control" readonly>
                                  <span class="help-block"></span>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="f_condition" class="col-sm-4 control-label">Stand By</label>
                        <div class="col-sm-8">
                            <input type="text" name="f_stby" id="f_stby" class="form-control" readonly>
                                  <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="f_condition" class="col-sm-4 control-label">Use of Availability</label>
                        <div class="col-sm-8">
                            <input type="text" name="f_ua" class="form-control" id="f_ua" readonly> 
                                  <span class="help-block"></span>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="f_condition" class="col-sm-4 control-label">Physical Availability</label>
                        <div class="col-sm-8">
                            <input type="text" name="f_pa" class="form-control" id="f_pa" readonly> 
                                  <span class="help-block"></span>
                        </div>
                    </div>
