...
class Tax_model extends CI_Model {
	...
	var $table = 'hr_tax_status';
	var $column_order = array('hr_tax_status.empcode','emp_master.empname','hr_tax_status.start_date','hr_tax_status.familystatustax','hr_tax_status.familystatusrice',null); //set column field database for datatable orderable
	var $column_search = array('hr_tax_status.empcode','emp_master.empname','hr_tax_status.start_date','hr_tax_status.familystatustax','hr_tax_status.familystatusrice'); //set column field database for datatable searchable just firstname , lastname , address are searchable
	var $order = array('hr_tax_status.start_date' => 'desc'); // default order 
	...
	private function _get_datatables_query()
	{
		...
		//$this->db->from($this->table);
		$this->db->select('hr_tax_status.empcode, hr_tax_status.id_tax_sk, emp_master.nik_pim , emp_master.empname, hr_tax_status.start_date, hr_tax_status.familystatusrice, hr_tax_status.familystatustax');
		$this->db->from($this->table);
		$this->db->join('emp_master', 'hr_tax_status.empcode = emp_master.empcode');
	...
	{
		$this->db->select('hr_tax_status.empcode, hr_tax_status.id_tax_sk, emp_master.empname, hr_tax_status.start_date, hr_tax_status.familystatusrice, hr_tax_status.familystatustax');
		$this->db->from($this->table);
		$this->db->where('hr_tax_status.id_tax_sk',$id);
		$this->db->join('emp_master','hr_tax_status.empcode = emp_master.empcode');
		$query = $this->db->get();
