...
/*fungsi menghitung interval dua tanggal*/
...
$('#f_end_date').change(function(){
    ...
    console.log(Date.getFormattedDateDiff(start, end));*/
      $('#f_masa_kerja').val(Date.getFormattedDateDiff(start, end));
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('hr/hr/doc_status_list')?>",
            "type": "POST"
        },
   ...
   /* $('#f_update_date').val('<?php echo date("Y-m-d h:i:s"); ?>');*/
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="f_status_kontrak"]').val(data.contract_status).trigger('change');
      ...
      <td>
        <table>
          ...
          <tr>
            <td>Contract Type</td>
            <td>
          <select class="form-control select2" style="width: 100%;" name="f_status_kontrak">
            <option value="PKWTI">PKWT-I</option>
            <option value="PKWTII">PKWT-II</option>
