...
for ($i=0; $i <= 11 ; $i++) { 
    ...
    echo "<table id='customers'>
            <tr>
                <th colspan=6>Karyawan Masuk Periode ".$nama_bulan."-".$tahun."</th>
            </tr>
            <tr>
                <th>No</th>
                <th>NIK</th>
...
echo "<br>";
    echo "<table id='customers'>
            <tr>
                <th colspan=6>Karyawan Keluar Periode ".$nama_bulan."-".$tahun."</th>
            </tr>
            <tr>
                <th>No</th>
                <th>NIK</th>
            ...
            $no=1;
            if (!empty($emp_out_monthly[$i])) {
                foreach ($emp_out_monthly[$i] as $key) {
                    echo "<tr><td>".$no."</td>";
                    echo "<td>".$key->nik_pim."</td>";
                    echo "<td>".$key->empname."</td>";
                    echo "<td>".$key->position."</td>";
                    echo "<td>".date_indonesia($key->dateterminate)."</td>";
                    echo "<td>".$key->employeetype."</td></tr>";
                    $no++;
            }
            }
