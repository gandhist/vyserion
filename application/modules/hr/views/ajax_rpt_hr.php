...
$(document).ajaxStart(function () {
    Pace.restart()
            ...
            $(document).ready(function () {
                ...
                $("#report").addClass("treeview active");
                $("#report_parameter_hr").addClass("active");
...
//datatables
    ...
    table = $('#table').DataTable({ 
       ...
       // "responsive": true, //Feature control DataTables' server-side processing mode.
        "scrollX": true, //Feature control DataTables' server-side processing mode.
        ...
        "ajax": {
            "url": "<?php echo site_url('hr/ajax_rpt_list')?>",
            "type": "POST",
            "data": function (data) {
                ...
                else
                {
                    ...
                    data.filter_start_date = date_st;
                    data.filter_end_date = date_en;
                }
