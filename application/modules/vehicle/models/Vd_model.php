...
class Vd_model extends CI_Model {
	...
	var $column_order = array('a.doc_no', 'b.nomor_plat', 'a.nap','b.code_unit', 'a.doc_type', 'a.valid_until', null, null, null ,null); //set column field database for datatable orderable
	var $column_search = array('a.doc_no', 'b.nomor_plat', 'a.nap', 'b.code_unit', 'a.doc_type', 'a.valid_until', 'a.remarks', 'a.masa_berlaku'); //set column field database for datatable searchable just firstname , lastname , address are searchable
	...
	private function _get_datatables_query()
	{
        ...
        {
            $this->db->where('a.valid_until BETWEEN "'.$this->input->post("filter_start").'" AND "'.$this->input->post("filter_end").'"');
        }
        /*
  ...
  a.remarks,
  a.masa_berlaku ');
        $this->db->from('document_vehicle a');
        $this->db->join('vehicle_master b','a.nap = b.nap','inner');
        ...
        $this->db->order_by('a.inputdate','desc');
