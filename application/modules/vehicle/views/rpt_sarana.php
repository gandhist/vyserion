        ...
        <div class="col-xs-12">
         <div class="box">
            ...
            <div class="panel-body">
                <form action="<?php echo base_url(); ?>vehicle/rpt_sarana_support" id="form-filter"  target="_blank" method="POST" class="form-horizontal">
                    <div class="form-group">
                        <label for="filter_empcode" class="col-sm-2 control-label">Code Unit</label>
                        <div class="col-sm-4">
                            <?php
                                  $attribute = 'class="form-control select2" id="filter_empcode" style="width: 100%; display:none;"';
                                  echo form_dropdown('filter_empcode', $dd_vehicle_code, $vehicle_code, $attribute);
                                  ?> 
                                 <!--  <input type="text" name="empcode" id="empcode"> -->
                        </div>
                    </div>
                    <!-- <div class="form-group">
                        <label for="filter_empcode" class="col-sm-2 control-label">Status</label>
                        <div class="col-sm-4">
                          <!--  <?php
                                  $attribute = 'class="form-control select2" id="filter_empcode" style="width: 100%; display:none;"';
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php
                                  ...
                                  echo form_dropdown('filter_dept', $dd_dept, $dd_dept_selected, $dept_attribute);
                                  ?>
                        </div>
                    </div> -->
                    <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <!-- <input type="text" class="form-control" id="filter_end_date"> -->
                            <input type="text" name="print_date" id="print_date" class="form-control" placeholder="dd-mm-yyyy" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask > <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="f_period" class="col-sm-2 control-label">Order By</label>
                         <div class="col-sm-4">
                          <select class="form-control select2" style="width: 100%;" name="order_by" id="order_by">
            <option value="code_unit">Code Unit</option>
            <option value="nap">Nap</option>
            <option value="nomor_plat">No Plat</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <!-- <input type="text" class="form-control" id="filter_start_date"> -->
                            <input type="text" id="prepared_by" name="prepared_by" class="form-control" placeholder="Prepared By"><span class="help-block">
                        </div>
                    </div>
                    <div class="form-group">
