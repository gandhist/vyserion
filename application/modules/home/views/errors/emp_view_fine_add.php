  ...
  <tbody>
    <tr>
      ...
      <table cellpadding="50" cellspacing="50">
        ...
        <input type="hidden" style="display:none;" name="f_update_by" value="">
        <input type="hidden" style="display:none;" name="f_update_date" value="">
                              <tr>
                                <td>NIK </td>
                                <td><input type="text" name="f_empcode" class="form-control" 
                                  value="<?php echo $empcode; ?>" readonly><span class="help-block">
                                   </td>
                              </tr>
                              <tr>
                                <td>Name </td>
