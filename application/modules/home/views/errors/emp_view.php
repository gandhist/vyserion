    ...
    <tr>
      ...
      <table cellpadding="50" cellspacing="50">
        ...
        <input type="hidden" style="display:none;" name="f_update_date" value="">
                              ...
                              <tr>
                                <td>Date Of Birth</td>
                                <td><input type="text" name="f_date_of_birth" class="form-control" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask><span class="help-block"></span></td>
                              </tr>
                              <tr>
                                <td>Citizen</td>
                                <td><input type="text" name="f_citizen" class="form-control"><span class="help-block"></span></td>
                              </tr>
                              <tr>
                                <td>SEX</td>
                                <td>
