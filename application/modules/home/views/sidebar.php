          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview" id="report_payroll">
              ...
              <ul class="treeview-menu">
                ...
                <li id="report_gang_activity"><a href="<?php echo base_url('payroll/rpt_rekap_sallary'); ?>"><i class="fa fa-circle-o"></i> Report Rekap Gaji</a></li>
        ...
        <li class="treeview" id="vehicle">
          ...
          <ul class="treeview-menu">
            <li class="treeview" id="input_vehicle">
              ...
              <ul class="treeview-menu" >
                <li id="vehicle_document"><a href="<?php echo base_url('vehicle/vehicle_document'); ?>"><i class="fa fa-circle-o"></i> Vehicle Services</a></li>
              </ul>
            </li>
